...
export class MemStorage implements IStorage {
  ...
  private initializeDefaultData() {
    ...
    // Initialize patients
    const patientData = [
      { firstName: "Brooklyn", lastName: "Simmons", gender: "M", dateOfBirth: "1995-03-18", phone: "555-1234", email: "brooklyn@example.com" },
      { firstName: "Anthony", lastName: "Johnson", gender: "M", dateOfBirth: "1997-03-18", phone: "555-5678", email: "anthony@example.com" },
      { firstName: "Sarah", lastName: "Miller", gender: "F", dateOfBirth: "1987-03-18", phone: "555-9012", email: "sarah@example.com" },
    ];
