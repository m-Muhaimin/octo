...
import { Send, Bot, FileText, TrendingUp, DollarSign, Users, BarChart, Activity, Sparkles, Clock, CheckCircle } from "lucide-react";
...
export default function EnhancedAIAssistantModal({ open, onOpenChange }: EnhancedAIAssistantModalProps) {
  ...
  const quickActions: QuickAction[] = [
    { 
      ...
      icon: DollarSign, 
      query: 'Provide a comprehensive financial analysis including revenue, expenses, and net income with actionable recommendations',
    ...
    { 
      ...
      icon: Users, 
      query: 'Analyze patient demographics, growth trends, and patient engagement patterns',
    ...
    { 
      ...
      icon: Activity, 
      query: 'Review appointment scheduling efficiency, completion rates, and scheduling optimization opportunities',
    ...
    { 
      ...
      icon: BarChart, 
      query: 'Examine transaction patterns, payment methods, and outstanding payments with collection recommendations',
    ...
    { 
      ...
      icon: TrendingUp, 
      query: 'Generate an overall practice performance report with key metrics and improvement recommendations',
    ...
    { 
      ...
      icon: FileText, 
      query: 'Identify potential risks in billing, appointments, and patient management with mitigation strategies',
      ...
      <DialogContent className="sm:max-w-[900px] h-[700px] flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-2">
            ...
            <Badge variant="secondary" className="ml-2">Enhanced Analytics</Badge>
          </DialogTitle>
        </DialogHeader>
            ...
            <Card className="mt-4">
              <CardContent className="pt-4">
                ...
                <div className="text-xs text-gray-500">
                  AI responses are based on your actual practice data including patients, appointments, and transactions.
                </div>
              </CardContent>
            </Card>
          </div>
